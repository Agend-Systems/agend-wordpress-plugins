...
use Agend_Elementor_Courses_Catalogue;
...
require_once AGEND_TESTS_ROOT . '/agend-elementor/includes/widgets/class-agend-elementor-courses-catalogue.php';
 ...
 */
final class Courses_Catalogue_Controls_Test_Harness extends Agend_Elementor_Courses_Catalogue {
...
final class CoursesCatalogueControlsTest extends TestCase {
	...
	public function should_register_the_same_content_tab_controls_as_the_pre_refactor_widget(): void {
		$fixture = json_decode(
			file_get_contents( __DIR__ . '/fixtures/courses-catalogue-content-controls.json' ),
			true
		);

		$widget = new Courses_Catalogue_Controls_Test_Harness();
		$widget->run();
