 ...
 */
final class Member_Login_Controls_Test_Harness extends Agend_Elementor_Member_Login {
...
final class MemberLoginControlsTest extends TestCase {
	...
	public function should_register_the_same_content_tab_controls_as_the_pre_refactor_widget(): void {
		$fixture = json_decode(
			file_get_contents( __DIR__ . '/fixtures/member-login-content-controls.json' ),
			true
		);

		$widget = new Member_Login_Controls_Test_Harness();
		$widget->run();
