...
use Agend_Elementor_Memberships_Catalogue;
...
require_once AGEND_TESTS_ROOT . '/agend-elementor/includes/widgets/class-agend-elementor-memberships-catalogue.php';
 ...
 */
final class Memberships_Catalogue_Controls_Test_Harness extends Agend_Elementor_Memberships_Catalogue {
...
final class MembershipsCatalogueControlsTest extends TestCase {
	...
	public function should_register_the_same_content_tab_controls_as_the_pre_refactor_widget(): void {
		$fixture = json_decode(
			file_get_contents( __DIR__ . '/fixtures/memberships-catalogue-content-controls.json' ),
			true
		);

		$widget = new Memberships_Catalogue_Controls_Test_Harness();
		$widget->run();
