 ...
 */
final class Account_Link_Controls_Test_Harness extends Agend_Elementor_Account_Link {
...
final class AccountLinkControlsTest extends TestCase {
	...
	public function should_register_the_same_content_tab_controls_as_the_pre_refactor_widget(): void {
		$fixture = json_decode(
			file_get_contents( __DIR__ . '/fixtures/account-link-content-controls.json' ),
			true
		);

		$widget = new Account_Link_Controls_Test_Harness();
		$widget->run();
