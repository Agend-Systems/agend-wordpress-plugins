...
class Agend_Elementor_Courses_Catalogue extends \Elementor\Widget_Base {
	...
	public function get_script_depends(): array {
		return array( 'agend-apps-records-courses-catalogue' );
	}
	...
	private function register_content_controls(): void {
		Agend_Elementor_Schema_Controls::register( $this, agend_apps_records_surface_schema( 'courses-catalogue' ) );
	}
	...
	protected function render(): void {
		...
		echo agend_apps_records_render_courses_catalogue( Agend_Elementor_Global_Colours::resolve( $this->get_settings_for_display() ) ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- Escaped by the core renderer.
	}
}
