...
class Agend_Elementor_Record_Link extends \Elementor\Widget_Base {
	...
	/**
	 * Actions and their default labels.
	 *
	 * @return array<string, string>
	 */
	private function action_options(): array {
		$options = array(
			'detail'    => __( 'Open detail page', 'agend-elementor' ),
			'catalogue' => __( 'Back to catalogue', 'agend-elementor' ),
			'register'  => __( 'Register (events)', 'agend-elementor' ),
			'enrol'     => __( 'Enrol (courses)', 'agend-elementor' ),
			'ical'      => __( 'Add to calendar (events)', 'agend-elementor' ),
			'custom'    => __( 'Custom URL', 'agend-elementor' ),
		);
		return $options;
	}
	...
	protected function register_controls(): void {
		...
		$this->add_control(
			'action',
			array(
				'label'   => __( 'Action', 'agend-elementor' ),
		...
		$this->add_control(
			'custom_url',
			array(
				'label'       => __( 'URL', 'agend-elementor' ),
				'type'        => \Elementor\Controls_Manager::TEXT,
				'default'     => '',
				'label_block' => true,
				'description' => __( 'Use {slug} and {title} as placeholders for the record values.', 'agend-elementor' ),
		...
		$this->add_control(
			...
			array(
				...
				'type'        => \Elementor\Controls_Manager::TEXT,
				'default'     => '',
				'description' => __( 'Leave empty for the default label of the chosen action.', 'agend-elementor' ),
			)
		);
		...
		$this->add_control(
			'style_as',
			array(
				'label'   => __( 'Appearance', 'agend-elementor' ),
				'type'    => \Elementor\Controls_Manager::SELECT,
				'default' => 'button',
				'options' => array(
					'button' => __( 'Button', 'agend-elementor' ),
					'link'   => __( 'Text link', 'agend-elementor' ),
				),
			)
		);
		...
		$this->add_control(
			'new_tab',
			array(
				'label'     => __( 'Open in new tab', 'agend-elementor' ),
				'type'      => \Elementor\Controls_Manager::SWITCHER,
				'default'   => '',
		...
		$this->add_control(
			'disabled_when_sold_out',
			array(
				'label'     => __( 'Disable when sold out', 'agend-elementor' ),
				'type'      => \Elementor\Controls_Manager::SWITCHER,
				'default'   => 'yes',
		...
		$this->add_control(
			'hide_when_registered',
			array(
				'label'     => __( 'Hide when the viewer is already registered', 'agend-elementor' ),
				'type'      => \Elementor\Controls_Manager::SWITCHER,
				'default'   => '',
				'condition' => array( 'action' => 'register' ),
			)
		...
		$this->add_control(
			'hide_when_enrolled',
			array(
				'label'     => __( 'Hide when the viewer is already enrolled', 'agend-elementor' ),
				'type'      => \Elementor\Controls_Manager::SWITCHER,
				'default'   => 'yes',
