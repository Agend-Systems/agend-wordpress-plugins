...
/**
 * `Agend_Apps_Records_Pages::redirect_target()`: the pure decision behind the
 * wp:4 redirect (`agend_apps_records_maybe_redirect_to_dedicated_page()`). The
...
final class RedirectDecisionTest extends TestCase {
	...
	public function should_redirect_to_the_dedicated_page_when_on_another_page(): void {
		...
		$target = Agend_Apps_Records_Pages::redirect_target( 'event', 'my-slug', 9 );
	...
	public function should_return_empty_when_already_on_the_dedicated_page(): void {
		...
		$target = Agend_Apps_Records_Pages::redirect_target( 'event', 'my-slug', 5 );
	...
	public function should_return_empty_when_the_type_is_unconfigured(): void {
		$target = Agend_Apps_Records_Pages::redirect_target( 'course', 'my-slug', 9 );
	...
	public function should_return_empty_for_an_empty_slug(): void {
		...
		$target = Agend_Apps_Records_Pages::redirect_target( 'event', '', 9 );
